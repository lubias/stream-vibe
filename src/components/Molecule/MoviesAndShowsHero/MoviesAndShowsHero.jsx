...
function MoviesAndShowsHero() {
    return (
        <div className='px-40 lg_1:px-20 sm_1:px-5 bg-black-08 mb-40'>
            <div className='bg-[url("/images/movies_hero.png")] bg-cover bg-no-repeat min-h-[800px] lg_4:px-2 w-full flex flex-col gap-12 justify-end items-center px-48'>
                <div className='flex flex-col gap-5 items-center mb-32'>
                    <h1 className='text-4xl lg_4:text-2xl bold text-center'>Avengers : Endgame</h1>
