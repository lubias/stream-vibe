...
function CardFreeTrail() {
    return (
        <div className='w-full pb-32 bg-black-08 flex'>
            <div className='bg-[url("/images/background_card.png")] h-80 w-full flex items-center justify-between px-20 gap-14 lg_4:flex-col lg_4:justify-center'>
                <div className='flex-1 lg_4:flex-none'>
